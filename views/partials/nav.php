            ...
            <div class="flex items-center">
                ...
                <div class="hidden md:block">
                    <div class="ml-10 flex items-baseline space-x-4">
                        ...
                        <a href="/" aria-current="page" class="<?= urlIs('/') ? 'bg-gray-900 text-white' : 'text-gray-300'; ?> ?> rounded-md px-3 py-2 text-sm font-medium text-white">Home</a>
                        <a href="/about" class="<?= ($_SERVER['REQUEST_URI'] === '/about.php') ? 'bg-gray-900 text-white' : 'text-gray-300'; ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">About</a>
                        <a href="/notes" class="<?= ($_SERVER['REQUEST_URI'] === '/notes.php') ? 'bg-gray-900 text-white' : 'text-gray-300'; ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Notes</a>
                        <a href="/contact-us" class="<?= ($_SERVER['REQUEST_URI'] === '/contact-us.php') ? 'bg-gray-900 text-white' : 'text-gray-300'; ?> rounded-md px-3 py-2 text-sm font-medium text-gray-300 hover:bg-white/5 hover:text-white">Contact Us</a>
                    </div>
                </div>
            </div>
            <div class="hidden md:block">
